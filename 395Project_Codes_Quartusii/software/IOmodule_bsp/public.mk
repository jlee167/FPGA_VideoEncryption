...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../cam_soc.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x100030c0
SOPC_SYSID_FLAG += --sidp=0x100030c0
ELF_PATCH_FLAG  += --sidp 0x100030c0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1461113250
SOPC_SYSID_FLAG += --timestamp=1461113250
ELF_PATCH_FLAG  += --timestamp 1461113250
