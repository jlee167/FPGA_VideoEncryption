...
alias com {
  echo "\[exec\] com"
  vlog       "$QSYS_SIMDIR/submodules/cam_soc_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv" -work error_adapter_0                             
  vlog -v2k5 "$QSYS_SIMDIR/submodules/cam_soc_mm_interconnect_0_avalon_st_adapter.v"                  -work avalon_st_adapter                           
  ...
  vlog       "$QSYS_SIMDIR/submodules/cam_soc_mm_interconnect_0_rsp_mux_001.sv"                       -work rsp_mux_001                                 
  vlog       "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                    -work rsp_mux                                     
  vlog       "$QSYS_SIMDIR/submodules/cam_soc_mm_interconnect_0_rsp_mux.sv"                           -work rsp_mux                                     
  vlog       "$QSYS_SIMDIR/submodules/cam_soc_mm_interconnect_0_rsp_demux_001.sv"                     -work rsp_demux_001                               
  vlog       "$QSYS_SIMDIR/submodules/cam_soc_mm_interconnect_0_rsp_demux.sv"                         -work rsp_demux                                   
  vlog       "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                    -work cmd_mux_001                                 
  vlog       "$QSYS_SIMDIR/submodules/cam_soc_mm_interconnect_0_cmd_mux_001.sv"                       -work cmd_mux_001                                 
  vlog       "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                    -work cmd_mux                                     
  vlog       "$QSYS_SIMDIR/submodules/cam_soc_mm_interconnect_0_cmd_mux.sv"                           -work cmd_mux                                     
  vlog       "$QSYS_SIMDIR/submodules/cam_soc_mm_interconnect_0_cmd_demux_001.sv"                     -work cmd_demux_001                               
  vlog       "$QSYS_SIMDIR/submodules/cam_soc_mm_interconnect_0_cmd_demux.sv"                         -work cmd_demux                                   
  vlog       "$QSYS_SIMDIR/submodules/cam_soc_mm_interconnect_0_router_003.sv"                        -work router_003                                  
  vlog       "$QSYS_SIMDIR/submodules/cam_soc_mm_interconnect_0_router_002.sv"                        -work router_002                                  
  vlog       "$QSYS_SIMDIR/submodules/cam_soc_mm_interconnect_0_router_001.sv"                        -work router_001                                  
  vlog       "$QSYS_SIMDIR/submodules/cam_soc_mm_interconnect_0_router.sv"                            -work router                                      
  ...
  vlog -v2k5 "$QSYS_SIMDIR/submodules/cam_soc_nios2_qsys_0_cpu.v"                                     -work cpu                                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/cam_soc_nios2_qsys_0_cpu_debug_slave_sysclk.v"                  -work cpu                                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/cam_soc_nios2_qsys_0_cpu_debug_slave_tck.v"                     -work cpu                                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/cam_soc_nios2_qsys_0_cpu_debug_slave_wrapper.v"                 -work cpu                                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/cam_soc_nios2_qsys_0_cpu_test_bench.v"                          -work cpu                                         
  ...
  vlog       "$QSYS_SIMDIR/submodules/cam_soc_irq_mapper.sv"                                          -work irq_mapper                                  
  vlog -v2k5 "$QSYS_SIMDIR/submodules/cam_soc_mm_interconnect_0.v"                                    -work mm_interconnect_0                           
  vlog -v2k5 "$QSYS_SIMDIR/submodules/cam_soc_to_sw_sig.v"                                            -work to_sw_sig                                   
  vlog -v2k5 "$QSYS_SIMDIR/submodules/cam_soc_to_sw_port.v"                                           -work to_sw_port                                  
  vlog -v2k5 "$QSYS_SIMDIR/submodules/cam_soc_to_hw_port.v"                                           -work to_hw_port                                  
  vlog -v2k5 "$QSYS_SIMDIR/submodules/cam_soc_sysid_qsys_0.vo"                                        -work sysid_qsys_0                                
  vlog -v2k5 "$QSYS_SIMDIR/submodules/cam_soc_sdram_pll.vo"                                           -work sdram_pll                                   
  vlog -v2k5 "$QSYS_SIMDIR/submodules/cam_soc_sdram.v"                                                -work sdram                                       
  vlog -v2k5 "$QSYS_SIMDIR/submodules/cam_soc_onchip_memory2_0.v"                                     -work onchip_memory2_0                            
  vlog -v2k5 "$QSYS_SIMDIR/submodules/cam_soc_nios2_qsys_0.v"                                         -work nios2_qsys_0                                
  vlog -v2k5 "$QSYS_SIMDIR/submodules/cam_soc_led.v"                                                  -work led                                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/cam_soc_jtag_uart_0.v"                                          -work jtag_uart_0                                 
  vlog -v2k5 "$QSYS_SIMDIR/cam_soc.v"                                                                                                                   
}
