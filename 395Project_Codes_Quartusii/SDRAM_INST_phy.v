...
// ============================================================
// Megafunction Name(s):
// 			SDRAM_INST_phy_alt_mem_phy
// ============================================================
// Generated by altmemphy 14.0 [Altera, IP Toolbench 1.3.0 Build 200]
// ************************************************************
...
module SDRAM_INST_phy (
	...
	SDRAM_INST_phy_alt_mem_phy	SDRAM_INST_phy_alt_mem_phy_inst(
	...
	defparam
		SDRAM_INST_phy_alt_mem_phy_inst.FAMILY = "Cyclone IV E",
		SDRAM_INST_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR",
		SDRAM_INST_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		SDRAM_INST_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		SDRAM_INST_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		SDRAM_INST_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		SDRAM_INST_phy_alt_mem_phy_inst.DQS_PHASE = 6000,
		SDRAM_INST_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		SDRAM_INST_phy_alt_mem_phy_inst.DWIDTH_RATIO = 2,
		SDRAM_INST_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 8,
		SDRAM_INST_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 12,
		SDRAM_INST_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 2,
		SDRAM_INST_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		SDRAM_INST_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		SDRAM_INST_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 1,
		SDRAM_INST_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		SDRAM_INST_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		SDRAM_INST_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 1,
		SDRAM_INST_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		SDRAM_INST_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		SDRAM_INST_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 6667,
		SDRAM_INST_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "6667 ps",
		SDRAM_INST_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 50,
		SDRAM_INST_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 0,
		SDRAM_INST_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		SDRAM_INST_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		SDRAM_INST_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 64,
		SDRAM_INST_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		SDRAM_INST_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		SDRAM_INST_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		SDRAM_INST_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		SDRAM_INST_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0;
endmodule
...
// Retrieval info: <MEGACORE title="ALTMEMPHY"  version="14.0"  build="198"  iptb_version="1.3.0 Build 200"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="SDRAM_INST_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "alt_top" value="SDRAM_INST_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="SDRAM_INST_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+SDRAM_INST_phy_alt_mem_phy_seq_wrapper;+SDRAM_INST_phy_alt_mem_phy_reconfig;+SDRAM_INST_phy_alt_mem_phy_pll;+SDRAM_INST_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\Users\jihoon\Desktop\bckup - Copy\FPGA_VideoEncryption\395Project_Codes_Quartusii/SDRAM_INST_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="SDRAM_INST_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
