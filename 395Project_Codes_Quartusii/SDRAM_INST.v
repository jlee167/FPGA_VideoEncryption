// megafunction wizard: %DDR High Performance Controller v14.0%
// GENERATION: XML

// ============================================================
// Megafunction Name(s):
// 			SDRAM_INST_controller_phy
// ============================================================
// Generated by DDR High Performance Controller 14.0 [Altera, IP Toolbench 1.3.0 Build 200]
// ************************************************************
...
module SDRAM_INST (
	...
	SDRAM_INST_controller_phy	SDRAM_INST_controller_phy_inst(
...
// Retrieval info: <MEGACORE title="DDR SDRAM Controller with ALTMEMPHY"  version="14.0"  build="200"  iptb_version="1.3.0 Build 200"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRControllerMVCModel"  active_core="SDRAM_INST_controller_phy" >
...
// Retrieval info:      <PRIVATE name = "alt_top" value="SDRAM_INST_alt_mem_ddrx_controller_top"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "nativelink_excludes" value="SDRAM_INST_phy_alt_mem_phy_seq.vhd,SDRAM_INST_phy_alt_mem_phy_seq_wrapper.vhd,SDRAM_INST_phy_alt_mem_phy_seq_wrapper.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="SDRAM_INST_alt_mem_ddrx_controller_top.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+SDRAM_INST_alt_mem_phy_seq_wrapper;+SDRAM_INST_alt_mem_phy_reconfig;+SDRAM_INST_alt_mem_phy_pll;+SDRAM_INST_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\Users\jihoon\Desktop\bckup - Copy\FPGA_VideoEncryption\395Project_Codes_Quartusii/SDRAM_INST_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="SDRAM_INST_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
